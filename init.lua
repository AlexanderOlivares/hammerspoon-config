...
hs.hotkey.bind({"`", "cmd"}, "m", function() hs.application.launchOrFocus("Brave Browser"); c() end)
...
hs.hotkey.bind({"`", "cmd"}, "b", function() hs.application.launchOrFocus("NoSQLBooster for MongoDB"); c() end)
